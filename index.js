...
const nameBand = 'BREAKING BAD';

let nameSongs = [
	"BABY BLUE", /*1*/
	"BREAKING BAD THEME ", /*2*/
	"BLACK", /*3*/
	"CRYSTAL BLUE PERSUASION ", /*4*/
	"GINZA SAMBA -", /*5*/
	"THE BALLAD OF HEISENBERG ", /*6*/
	" WALT BANGERS BALLAD", /*7*/
	"APOLLO JUMP", /*8*/
	"WINDY ", /*9*/
	"KENNY ROGERS", /*10*/
	"ONE BY ONE ", /*11*/
	"DLZ ", /*12*/
	"IT’S SUCH A PRETTY WORLD TODAY", /*13*/
	"GOOD TIMES", /*14*/
	"OUT OF TIME MAN", /*15*/
	"EL PASO - MARTY ROBBINS", /*16*/
	"SHAMBALA", /*17*/
	"SO INDIFFERENT BLUES", /*18*/
	"FREESTYLER ", /*19*/
	"ENCHANTED ", /*20*/
]
